...
class mysql {
    ...
    public function select_db($db = false) {
		...
		if ($this->database and strlen($this->database)) {
    ...
    private function error($str) {
		$this->error['query'] = ":\r" . $this->current_query . "\r\r";
		$this->error['message'] = "MySQL server returns :\r" . mysql_error();
	...
	public function getError() {
		return (sizeof($this->error)) ? $this->error : false;
	}
